		...
		<div id="index-header">
			...
			<div id="header">
				...
				<div id="header-menu-titre">
					...
					<div id="header-menu-titre-principal">
						<div id="header-menu-titre-principal-img"
							...
							<h1>Hôtel du Relais<span>THOUARS (79)</span></h1>
						</div>

					</div>

					<div id="header-menu-titre-secondaire">
						<a href="#index-reservation-titre" class="header-reserver"><label>RÉSERVER AU MEILLEUR
								PRIX</label></a>
					</div>
				...
				<div id="header-menu-tel">
					<div id="header-menu-tel-numero"
						style="background-image: url(pics/bandeau_haut/fond_gris_tel.png);">
			...
			<div id="header-menu">
				...
				<a href="hotel" class="header-tablecell">HÔTEL</a>
				...
				<a href="tourisme.php" class="header-tablecell">TOURISME</a>
				<a href="reservation" class="header-tablecell">RÉSERVATION</a>
				<a href="infos" class="header-tablecell">PRATIQUE</a>
			...
			<div id="header-menu-resp" onclick="MenuResp()">
				...
				<ul id="menuresp-ul">
					...
					<li> <a href="hotel" class="header-tablecell">HÔTEL</a></li>
					...
					<li><a href="tourisme.php" class="header-tablecell">TOURISME</a></li>
					<li><a href="reservation" class="header-tablecell">RÉSERVATION</a></li>
					<li><a href="infos" class="header-tablecell">PRATIQUE</a></li>
